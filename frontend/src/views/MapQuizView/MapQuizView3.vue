...
import TheQuestionThree from "@/components/MapQuizComponents/PageThree/TheQuestionThree.vue";
import TheButtonsTwo from "@/components/MapQuizComponents/PageThree/TheButtonsThree.vue";
</script>
<template>
