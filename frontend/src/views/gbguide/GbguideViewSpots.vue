...
<template>
  <main class="grid-cont">
    ...
    <div class="box1 box">
      <article
        ...
        >        <div class="artImageBoxClosed">
          <img src="/gbguide/viewspots/masthuggskyrkan.jpeg" class="artImageClosed" />
        </div>
        <div class="artTitleBoxClosed">
          <h1 class="artTitleClosed">1. Masthuggskyrkan</h1>
      ...
      <article class="artBoxOpen" v-show="openAccordion === 1">
        <div class="artImageBoxOpen">
          <img src="/gbguide/viewspots/masthuggskyrkan.jpeg" class="artImageOpen" />
        </div>
        <div class="artTitleBoxOpen">
          <h1 class="artTitleOpen">1. Masthuggskyrkan</h1>
    ...
    <div class="box2 box">
      ...
      >        <div class="artImageBoxClosed">
          <img src="/gbguide/viewspots/skansenlejonet.jpeg" class="artImageClosed" />
        </div>
        <div class="artTitleBoxClosed">
          <h1 class="artTitleClosed">2. Skansen Lejonet</h1>
          <div class="artTextBoxClosed">
            <p class="artTextClosed">
              Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor
              incididunt ut labore et dolore magna aliqua.
      ...
      <article class="artBoxOpen" v-show="openAccordion === 2">
        <div class="artImageBoxOpen">
          <img src="/gbguide/viewspots/skansenlejonet.jpeg" class="artImageOpen" />
        </div>
        <div class="artTitleBoxOpen">
          <h1 class="artTitleOpen">2. Skansen Lejonet</h1>
          <div class="artTextBoxOpen">
            <p class="artTextOpen">
              Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor
              incididunt ut labore et dolore magna aliqua.
    ...
    <div class="box3 box">
     <article
      ...
      >        <div class="artImageBoxClosed">
          <img src="/gbguide/viewspots/botaniska.jpeg" class="artImageClosed" />
        </div>
        <div class="artTitleBoxClosed">
      ...
      <article class="artBoxOpen" v-show="openAccordion === 3">
        <div class="artImageBoxOpen">
          <img src="/gbguide/viewspots/botaniska.jpeg" class="artImageOpen" />
        </div>
        <div class="artTitleBoxOpen">
    ...
    <div class="box4 box">
      ...
      >        <div class="artImageBoxClosed">
          <img src="/gbguide/viewspots/vattentornetislottsskogen.jpeg" class="artImageClosed" />
        </div>
        <div class="artTitleBoxClosed">
          <h1 class="artTitleClosed">4. Vattentornet i Slottskogen</h1>
          <div class="artTextBoxClosed">
            <p class="artTextClosed">
              Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor
              incididunt ut labore et dolore magna aliqua.
      ...
      <article class="artBoxOpen" v-show="openAccordion === 4">
        <div class="artImageBoxOpen">
          <img src="/gbguide/viewspots/vattentornetislottsskogen.jpeg" class="artImageOpen" />
        </div>
        <div class="artTitleBoxOpen">
          <h1 class="artTitleOpen">4. Vattentornet i Slottskogen</h1>
          <div class="artTextBoxOpen">
            <p class="artTextOpen">
              Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor
              incididunt ut labore et dolore magna aliqua.
    ...
    <div class="box5 box">
      ...
      >        <div class="artImageBoxClosed">
          <img src="/gbguide/viewspots/skansenkronan.jpeg" class="artImageClosed" />
        </div>
        <div class="artTitleBoxClosed">
          <h1 class="artTitleClosed">5. Skansen Kronan</h1>
          <div class="artTextBoxClosed">
            <p class="artTextClosed">
              Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor
              incididunt ut labore et dolore magna aliqua.
      ...
      <article class="artBoxOpen" v-show="openAccordion === 5">
        <div class="artImageBoxOpen">
          <img src="/gbguide/viewspots/skansenkronan.jpeg" class="artImageOpen" />
        </div>
        <div class="artTitleBoxOpen">
          <h1 class="artTitleOpen">5. Skansen Kronan</h1>
          <div class="artTextBoxOpen">
            <p class="artTextOpen">
              Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor
              incididunt ut labore et dolore magna aliqua.
