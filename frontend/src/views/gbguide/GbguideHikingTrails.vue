...
<template>
  ...
  <main>
    <header>
      <div class="imageBox">
        <img src="/gbguide/hikingtrails/hikeheader.jpg" class="headerImage" />
      </div>
      <div class="titleBox">
        <h1 class="title">Vandringsleder</h1>
      </div>
    </header>
    ...
    <div class="box1">
        ...
        >        <div class="artImageBoxClosed">
          <img src="/gbguide/hikingtrails/skargardsled.jpeg" class="artImageClosed" />
        </div>
        <div class="artTitleBoxClosed">
          <h1 class="artTitleClosed">1. Göteborgs Skärgårdsled</h1>
      ...
      <article class="artBoxOpen" v-show="openAccordion === 1">
        <div class="artImageBoxOpen">
          <img src="/gbguide/hikingtrails/skargardsled.jpeg" class="artImageOpen" />
        </div>
        <div class="artTitleBoxOpen">
          <h1 class="artTitleOpen">1. Göteborgs Skärgårdsled</h1>
    ...
    <div class="box2">
        ...
        >        <div class="artImageBoxClosed">
          <img src="/gbguide/hikingtrails/gotaleden.jpeg" class="artImageClosed" />
        </div>
        <div class="artTitleBoxClosed">
          <h1 class="artTitleClosed">2. Gotaleden</h1>
          <div class="artTextBoxClosed">
            <p class="artTextClosed">
              Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor
              incididunt ut labore et dolore magna aliqua.
      ...
      <article class="artBoxOpen" v-show="openAccordion === 2">
        <div class="artImageBoxOpen">
          <img src="/gbguide/hikingtrails/gotaleden.jpeg" class="artImageOpen" />
        </div>
        <div class="artTitleBoxOpen">
          <h1 class="artTitleOpen">2. Gotaleden</h1>
          <div class="artTextBoxOpen">
            <p class="artTextOpen">
              Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor
              incididunt ut labore et dolore magna aliqua.
    ...
    <div class="box3">
        ...
        >        <div class="artImageBoxClosed">
          <img src="/gbguide/hikingtrails/bohusleden.jpg" class="artImageClosed" />
        </div>
        <div class="artTitleBoxClosed">
          <h1 class="artTitleClosed">3. Bohusleden</h1>
          <div class="artTextBoxClosed">
            <p class="artTextClosed">
              Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor
              incididunt ut labore et dolore magna aliqua.
      ...
      <article class="artBoxOpen" v-show="openAccordion === 3">
        <div class="artImageBoxOpen">
          <img src="/gbguide/hikingtrails/bohusleden.jpg" class="artImageOpen" />
        </div>
        <div class="artTitleBoxOpen">
          <h1 class="artTitleOpen">3. Bohusleden</h1>
          <div class="artTextBoxOpen">
            <p class="artTextOpen">
              Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor
              incididunt ut labore et dolore magna aliqua.
    ...
    <div class="box4">
        ...
        >        <div class="artImageBoxClosed">
          <img src="/gbguide/hikingtrails/kuststigen.jpeg"  class="artImageClosed" />
        </div>
        <div class="artTitleBoxClosed">
          <h1 class="artTitleClosed">4. Kuststigen</h1>
          <div class="artTextBoxClosed">
            <p class="artTextClosed">
              Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor
              incididunt ut labore et dolore magna aliqua.
      ...
      <article class="artBoxOpen" v-show="openAccordion === 4">
        <div class="artImageBoxOpen">
          <img src="/gbguide/hikingtrails/kuststigen.jpeg" class="artImageOpen" />
        </div>
        <div class="artTitleBoxOpen">
          <h1 class="artTitleOpen">4. Kuststigen</h1>
          <div class="artTextBoxOpen">
            <p class="artTextOpen">
              Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor
              incididunt ut labore et dolore magna aliqua.
    ...
    <div class="box5">
        ...
        >        <div class="artImageBoxClosed">
          <img src="/gbguide/hikingtrails/storaamundon.jpeg" class="artImageClosed" />
        </div>
        <div class="artTitleBoxClosed">
          <h1 class="artTitleClosed">5. Stora Amundön</h1>
          <div class="artTextBoxClosed">
            <p class="artTextClosed">
              Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor
              incididunt ut labore et dolore magna aliqua.
      ...
      <article class="artBoxOpen" v-show="openAccordion === 5">
        <div class="artImageBoxOpen">
          <img src="/gbguide/hikingtrails/storaamundon.jpeg" class="artImageOpen" />
        </div>
        <div class="artTitleBoxOpen">
          <h1 class="artTitleOpen">5. Stora Amundön</h1>
          <div class="artTextBoxOpen">
            <p class="artTextOpen">
              Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor
              incididunt ut labore et dolore magna aliqua.
